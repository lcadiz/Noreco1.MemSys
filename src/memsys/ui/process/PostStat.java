...
public class PostStat extends javax.swing.JDialog {
    ...
    private void cmdpostActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdpostActionPerformed
        if (txtremarks.getText().isEmpty() == true) {
            ...
            rsAddConnLog(an, txtremarks.getText(), 4, ParentWindow.getUserID(), nowDate, "");
            this.dispose();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PostStat dialog = new PostStat(frmParent, true);
