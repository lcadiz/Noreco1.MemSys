...
public class CurrentPhoto extends javax.swing.JDialog {

    public static ManageProfile frmParent;
    public static String name;
    public static Capturer frmCapturer;
    public static String memID;

    public CurrentPhoto(ManageProfile parent, boolean modal) {
    ...
    public void showFrmCapturer() {
        frmCapturer = new Capturer(this, true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                CurrentPhoto dialog = new CurrentPhoto(frmParent, true);
