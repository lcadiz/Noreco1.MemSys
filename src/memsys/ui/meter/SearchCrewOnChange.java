...
public class SearchCrewOnChange extends javax.swing.JDialog {
    ...
    public SearchCrewOnChange(ChangeMeter parent, boolean modal) {
    ...
    void SelectNow() {
        ...
        if (tbl.isRowSelected(row) != true) {
            ...
            if (flg==1){
                 frmParent.LoadIssuedTo(Integer.parseInt(CrewID), CrewName);
            }else if (flg==2){
                 frmParent.LoadInstaller(Integer.parseInt(CrewID), CrewName);
            }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SearchCrewOnChange dialog = new SearchCrewOnChange(frmParent, true);
